...
export default function CuponeadorSignup() {
  ...
  const benefits = [
    {
      icon: DollarSign,
      text: "Comisiones inmediatas por cada cliente",
      color: "text-green-600"
    },
    {
      icon: Users,
      text: "Construye tu cartera de clientes",
      color: "text-blue-600"
    },
    {
      icon: Award,
      text: "Ranking mensual con premios",
      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <Button
            variant="ghost"
            size="icon"
            onClick={() => router.push(createPageUrl("Welcome"))}
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="bg-orange-50 border-l-4 border-[var(--urgent)] p-4">
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      />
                      {formData.birth_date &&
                        calculateAge(formData.birth_date) < 18 && (
                ...
                <div>
                  <Label htmlFor="motivation">
                    ¿Por qué quieres ser Cuponeador? *
                  </Label>
                  <Textarea
                    id="motivation"
                ...
                <div>
                  <Label htmlFor="sales_experience">
                    Experiencia en ventas (opcional)
                  </Label>
                  <Input
                    id="sales_experience"
                    ...
                    onChange={e =>
                      handleInputChange("sales_experience", e.target.value)}
                  />
                </div>
              </div>
              ...
              <div className="flex items-start space-x-2 pt-2">
                ...
                >
                  ...
                  del programa Cuponeador. Entiendo que soy un vendedor
                  independiente.
                </Label>
              </div>
        ...
        >
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Para cumplir con las regulaciones, necesitamos verificar tu
                identidad. Por favor, sube una foto clara de tu cédula o
            ...
            <div className="space-y-4 py-4">
              {idImageUrl ? (
                <div className="text-center">
                  ...
                  <p className="text-sm text-green-600 mt-2 flex items-center justify-center">
                    <CheckCircle className="w-4 h-4 mr-1" /> Documento
                    cargado.
                  </p>
                </div>
              ) : (
              ...
              <p className="text-xs text-gray-500 text-center">
                Tu información es privada y se usa solo para verificación.
              </p>
            </div>
            <DialogFooter>
              <Button

...
const planDetails = {
  pro: {
    name: "Pro",
    price: 15,
    features: ["10 cupones", "IA básica", "5K visualizaciones"]
  },
  avanzado: {
    name: "Avanzado",
    price: 35,
    features: ["Cupones ilimitados", "IA avanzada", "20K visualizaciones"]
  }
};
    ...
    return (
      <div className="bg-blue-50 border-l-4 border-blue-500 p-4 space-y-2">
        ...
        <p className="text-sm text-blue-700">
          2. Envía el pago a:{" "}
          <span className="font-bold">CUPONEA.PA</span>
        </p>
        <p className="text-sm text-blue-700">
          3. En el detalle, coloca tu email de registro.
        </p>
        <p className="text-sm text-blue-700">
          4. Haz clic en "Confirmar Pago" para notificarnos.
        </p>
      </div>
    );
  }
    ...
    return (
      <div className="bg-green-50 border-l-4 border-green-500 p-4 space-y-2">
        ...
        <p className="text-sm text-green-700">
          Banco: <span className="font-bold">Banco General</span>
        </p>
        <p className="text-sm text-green-700">
          Cuenta: <span className="font-bold">04-72-99-123456-7</span>
        </p>
        <p className="text-sm text-green-700">
          Nombre: <span className="font-bold">Cuponea Inc.</span>
        </p>
        <p className="text-sm text-green-700">
          Email para comprobante:{" "}
          <span className="font-bold">pagos@cuponea.app</span>
        </p>
      </div>
    );
  }
...
export default function Payment() {
  ...
  const handlePayment = async e => {
    ...
    try {
      ...
      const payment = await PaymentEntity.create({
        ...
        transaction_id:
          paymentMethod === "credit_card"
            ...
            : "manual_review", // ID depends on method
      ...
      alert(
        "Error al procesar el pago. Por favor, verifica tus datos e inténtalo de nuevo."
      );
    }
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="yearly">
                      Anual - ${Math.round(plan.price * 10)}/año{" "}
                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-2 mt-1">
                    ...
                    <Button
                      type="button"
                      variant={
                        paymentMethod === "yappy" ? "default" : "outline"
                      }
                      onClick={() => setPaymentMethod("yappy")}
                      className="flex-col h-16 bg-blue-500 hover:bg-blue-600 text-white data-[variant=outline]:bg-white data-[variant=outline]:text-blue-500"
                    >
                    ...
                    <Button
                      ...
                      className="flex-col h-16 bg-green-500 hover:bg-green-600 text-white data-[variant=outline]:bg-white data-[variant=outline]:text-green-500"
                    >
                ...
                >
                  {isProcessing ? (
                    ...
                    <>
                      ...
                      {paymentMethod === "credit_card"
                        ? `Pagar $${calculateTotal()} de forma segura`
                        : `Confirmar Pago de $${calculateTotal()}`}
                    </>
                  )}
                </Button>

                <p className="text-xs text-gray-500 text-center">
                  Al completar tu pago, aceptas nuestros términos de servicio y
                  política de privacidad. Puedes cancelar en cualquier momento.
                </p>
              </form>
            </CardContent>
          </Card>

  ...
  const handlePlanSelection = async planId => {
    ...
    if (planId === "freemium") {
      ...
      try {
        ...
        setTimeout(() => {
          window.open(
            "mailto:ventas@cuponea.com?subject=Plan Corporativo",
            "_blank"
          );
        }, 2000);
      } catch (error) {
      ...
      // Proceder al pago
      router.push(createPageUrl("Payment") + "?plan=" + planId);
    }
  };
                ...
                <CardHeader className={`${plan.bgColor} border-b`}>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      <div
                        className={`w-12 h-12 bg-gradient-to-r ${plan.color} rounded-full flex items-center justify-center`}
                      >

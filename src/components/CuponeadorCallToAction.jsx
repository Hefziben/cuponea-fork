...
import { DollarSign, TrendingUp, Award, Users, Zap, Crown, Target } from "lucide-react";
...
export default function CuponeadorCallToAction() {
  ...
  const handleBecomeAgent = () => {
    navigate(createPageUrl("CuponeadorSignup"));
  };
          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              <div className="flex items-center space-x-2">
                <h3 className="font-bold text-xl text-gray-900">¡Gana Dinero Extra!</h3>
              ...
              <p className="text-gray-700 mt-1 mb-4">
                ¿Te gustan las ventas? Conviértete en <strong>Cuponeador</strong> y gana comisiones ayudando a comercios locales.
              </p>
            </div>
          </div>
      ...
      <Dialog open={showInfoModal} onOpenChange={setShowInfoModal}>
        <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Conviértete en vendedor independiente y construye tu cartera de clientes
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-6 py-4">
            {/* Beneficios */}
            <div>
              <h3 className="font-semibold text-lg mb-3 text-gray-900">¿Por qué ser Cuponeador?</h3>
              <div className="grid gap-3">
                {benefits.map((benefit, index) => {
                  const Icon = benefit.icon;
                  return (
                    <div key={index} className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                      <Icon className={`w-5 h-5 mt-0.5 ${benefit.color}`} />
                      <div>
            ...
            <div>
              <h3 className="font-semibold text-lg mb-3 text-gray-900">Estructura de Comisiones</h3>
              <div className="overflow-hidden rounded-lg border">
                <table className="w-full text-sm">
                  <thead className="bg-gray-50">
                    <tr>
                      <th className="text-left p-3 font-medium text-gray-900">Plan Cliente</th>
                      <th className="text-center p-3 font-medium text-gray-900">Por Cierre</th>
                      <th className="text-center p-3 font-medium text-gray-900">Residual/mes</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-200">
                    ...
                    <tr key={index} className="hover:bg-gray-50">
                        <td className="p-3">
                          ...
                          <div className="text-xs text-gray-500">{item.monthly}/mes</div>
                        </td>
                        <td className="text-center p-3 font-bold text-green-600">{item.commission}</td>
                        <td className="text-center p-3 font-bold text-blue-600">{item.residual}</td>
                      </tr>
                    )}
                  </tbody>
                </table>
            ...
            <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg p-4">
              <h3 className="font-semibold text-purple-900 mb-2">🎯 Bonos por Volumen Mensual</h3>
            ...
            {/* Cómo Funciona */}
            <div>
              <h3 className="font-semibold text-lg mb-3 text-gray-900">¿Cómo Funciona?</h3>
              <div className="space-y-3">
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-green-500 text-white rounded-full flex items-center justify-center text-xs font-bold">1</div>
                  <div>
                    <div className="font-medium">Regístrate como Cuponeador</div>
                    <div className="text-sm text-gray-600">Obtienes tu código único y dashboard</div>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">Usa tu código para registrar nuevos clientes</div>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">Recibe pagos por cada cliente que se suscribe</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleBecomeAgent} className="bg-green-600 hover:bg-green-700">
              <Crown className="w-4 h-4 mr-2" />
              Comenzar Ahora
            </Button>
          </DialogFooter>

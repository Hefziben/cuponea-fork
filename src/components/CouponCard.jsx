...
export default function CouponCard({
  ...
  return (
    <Link href={createPageUrl("CouponDetail") + "?id=" + coupon.id}>
      <Card className="rounded-lg text-card-foreground shadow-sm overflow-hidden hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 bg-white/80 backdrop-blur-sm">
        <div className="relative">
          ...
          {coupon.is_featured && (
            <div
              className={`absolute ${coupon.enable_sharing
                ? "top-12"
                : "top-3"} right-3`}
            >
              ...
              <div className="flex items-center space-x-4">
                ...
                {daysLeft !== null && (
                  <div className="flex items-center space-x-1">
                    ...
                    <span
                      className={
                        daysLeft <= 3 ? "text-[var(--alert)] font-medium" : ""
                      }
                    >

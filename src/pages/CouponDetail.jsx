      ...
      <div className="flex items-center justify-between p-4">
        ...
        <div className="flex space-x-2">
          <Button
            ...
            size="icon"
            onClick={handleSave}
            className={`hover:bg-orange-100 ${isSaved ? 'text-red-500' : ''}`}>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center space-x-4">
            ...
            'bg-green-100 text-green-700'}`
              ...
              <span>
                {isExpired ? 'Vencido' : daysLeft <= 3 ? `Vence en ${daysLeft}d` : 'Vigente'}
              </span>
            </div>
            ...
            <div className="flex items-center space-x-1 text-orange-600 text-sm">
                ...
                <span>{coupon.current_uses || 0}/{coupon.max_uses} usados</span>
              </div>
            }
          </div>
        </div>
                ...
                <div
                  ...
                  style={{
                    backgroundImage: `url(https://api.qrserver.com/v1/create-qr-code/?size=128x128&data=${encodeURIComponent(
                      `${window.location.origin}${createPageUrl("VerifyCoupon")}?qr=${coupon.qr_code}&id=${coupon.id}`
                    )})`,

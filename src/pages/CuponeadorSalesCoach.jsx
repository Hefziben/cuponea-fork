...
import { ArrowLeft, BrainCircuit, MessageCircle, Target, Lightbulb, Users, DollarSign } from 'lucide-react';
...
const QuickTips = [
  {
    ...
    tip: "No vendas características, vende resultados. '¿Cuántos clientes nuevos quieres este mes?'"
  },
  {
    icon: Users,
    title: "Escucha Activamente", 
    tip: "Haz preguntas sobre sus desafíos actuales antes de presentar Cuponea como solución."
  },
  {
    icon: DollarSign,
    title: "ROI Claro",
    tip: "Muestra números concretos: 'Con 10 cupones activos, podrías atraer 100+ clientes nuevos.'"
  }
];
...
export default function CuponeadorSalesCoach() {
  ...
  useEffect(() => {
    ...
    setMessages([{
      type: 'coach',
      content: '¡Hola! Soy tu Coach de Ventas personal. 💪\n\n¿En qué puedo ayudarte hoy?\n• Preparar una presentación\n• Manejar objeciones\n• Estrategias de cierre\n• Análisis post-venta\n\nCuéntame tu situación...'
    }]);
  }, [loadUser]);
...
Respuesta:`;
      ...
      const errorMessage = { type: 'coach', content: 'Ups, tuve un problema técnico. ¿Puedes repetir tu pregunta?' };
  ...
  return (
    <div className="px-4 py-6 max-w-md mx-auto space-y-6 h-screen flex flex-col">
      ...
      <div className="flex items-center space-x-2 flex-shrink-0">
        <Button variant="ghost" size="icon" onClick={() => navigate(createPageUrl('CuponeadorDashboard'))}>
          ...
          <Card key={index} className="bg-gradient-to-r from-purple-50 to-blue-50 border-purple-200">
            <CardContent className="p-3">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-purple-800 text-sm">{tip.title}</h3>
      ...
      <Card className="flex-1 flex flex-col">
        ...
        <CardContent className="flex-1 flex flex-col">
          <ScrollArea className="flex-1 pr-4 mb-4" style={{ height: '300px' }}>
